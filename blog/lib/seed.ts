  ...
  const children: { type: string; version: number; [k: string]: unknown }[] = [
    {
      ...
      tag: 'h2' as const,
      version: 1,
      children: [{ type: 'text' as const, text: 'Introducción', version: 1 }],
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [{ type: 'text' as const, text: 'documentación oficial de Next.js', version: 1 }],
        },
        {
          type: 'text' as const,
    ...
    },
    {
      ...
      tag: 'h3' as const,
      version: 1,
      children: [{ type: 'text' as const, text: `Contexto sobre ${topicA}`, version: 1 }],
      direction: 'ltr' as const,
    },
    {
      type: 'paragraph' as const,
      ...
      children: [
        {
          ...
          version: 0,
          children: [
            { type: 'token' as const, text: 'interface ', version: 0 },
            { type: 'token' as const, text: 'Config', version: 0, format: 2 },
            { type: 'token' as const, text: ' {', version: 0 },
          ],
        },
        {
          type: 'line' as const,
          ...
          children: [
            { type: 'token' as const, text: '  ', version: 0 },
            { type: 'token' as const, text: 'name', version: 0, format: 8 },
            { type: 'token' as const, text: ': ', version: 0 },
            { type: 'token' as const, text: 'string', version: 0, format: 2 },
          ],
        },
        {
          type: 'line' as const,
          ...
          children: [
            { type: 'token' as const, text: '  ', version: 0 },
            { type: 'token' as const, text: 'debug', version: 0, format: 8 },
            { type: 'token' as const, text: '?: ', version: 0 },
            { type: 'token' as const, text: 'boolean', version: 0, format: 2 },
          ],
        },
        { type: 'line' as const, version: 0, children: [{ type: 'token' as const, text: '}', version: 0 }] },
      ],
      direction: 'ltr' as const,
    },
  ]
            ...
            children: [
              {
                ...
                version: 1,
                children: [
                  { type: 'text' as const, text: 'Usa siempre ', version: 1 },
                  { type: 'text' as const, text: 'strict: true', version: 1, format: 1 },
                  { type: 'text' as const, text: ' en tu ', version: 1 },
                  {
                    type: 'link' as const,
                    url: 'https://www.typescriptlang.org/tsconfig',
                    children: [{ type: 'text' as const, text: 'tsconfig.json', version: 1 }],
                  },
                  { type: 'text' as const, text: ' desde el día uno. Los tipos estrictos atrapan bugs que de otra forma solo verías en producción.', version: 1 },
                ],
                direction: 'ltr' as const,
              },
            ],
  ...
  children.push(
    {
      ...
      tag: 'h3' as const,
      version: 1,
      children: [{ type: 'text' as const, text: `Integrando con ${topicB}`, version: 1 }],
      direction: 'ltr' as const,
    },
    {
      type: 'paragraph' as const,
      ...
      children: [
        {
          ...
          version: 1,
          children: [
            { type: 'text' as const, text: 'Mantén la configuración centralizada en un solo archivo.', version: 1, format: '' as const },
          ],
        },
        {
          type: 'listitem' as const,
          version: 1,
          children: [
            { type: 'text' as const, text: 'Usa tipos estrictos desde el día uno — luego refactorizar es costoso.', version: 1, format: '' as const },
          ],
        },
        {
          type: 'listitem' as const,
